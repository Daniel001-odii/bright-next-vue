<template>
<div v-if="loading" class=" flex flex-col top-0 left-0 bottom-0 right-0 fixed z-10 bg-slate-50 justify-center items-center opacity-90">
    <div role="status">
        <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-bna_green" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="bg-white">
        <div class=" mt-12 flex flex-col h-screen justify-start items-center ">
            ...
            <div class=" rounded-3xl shadow-lg p-8 rounded-4xl flex flex-col w-fit">
                <div class="flex flex-row justify-between bg-bna_green_dark p-1 rounded-3xl">
                ...
                <div v-if="currentTab == 'login'">
                    <form @submit.prevent="login">
                        <h1 class="text-bna_green_dark text-3xl text-left py-6">Log in</h1>
                        <div class="flex flex-col gap-4 text-left">
                            ...
                            <button type="button" @click="login" class="bg-bna_green_dark w-full py-3 text-white rounded-3xl">Continue</button>
                        </div>
                    </form>
                ...
                <div v-if="currentTab == 'register'">
                    <form @submit.prevent="register">
                        <h1 class="text-bna_green_dark text-3xl text-left py-6">Create your account</h1>
                        <div class="flex flex-col gap-4 text-left">
                            ...
                            <button type="submit" class="bg-bna_green_dark w-full py-3 text-white rounded-3xl">Continue</button>
                        </div>
                    </form>
                    <div class="mt-5">
                        <!-- <GoogleLogin class="!w-full" :callback="callback" auto-login prompt> -->
...
<style scoped>
    ...
    .active_tab{
        @apply bg-white text-bna_green_dark
    }
